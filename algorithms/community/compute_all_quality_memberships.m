function [memberships,quals] = compute_all_quality_memberships(A, method, nreps)
%COMPUTE_ALL_QUALITY_MEMBERSHIPS Returns the all membership and quality values of a stochastic community detection method repeated a given number of times.
