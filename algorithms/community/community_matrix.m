function [B,C,K,n,m,p,Bnorm,commsizes] = community_matrix(W,ci)
%COMMUNITY_MATRIX 		Returns the block matrix of the community structure of a graph W with given membership vector ci
%
